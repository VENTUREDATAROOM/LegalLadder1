...
export default function ForgetPassword() {
  return (
     ...
     <div className="container md:flex bg-gray-200 min-h-screen  items-center justify-center ">
       ...
       <div className="right bg-white p-8 rounded-md md:w-1/3 lg:w-1/4 ">
        
         <p className="font-bold text-xl">
          <Link to='/resetpassword'>Forgot Password?</Link>
           </p>
         <p className='mt-2'>Please enter your registered email id</p>
         
         <p className='mt-3 text-center'>or</p>
         <div className='mt-2 mb-4 '>
           
           <p>Email</p>
           <input className='px-4 my-1 py-2 border-2 w-full	rounded  border-1 outline-blue-500' type="email" placeholder='Enter email address' />
           <p>error messagewill look like this</p>
  
           
         </div>
         <span className='space-x-1 '>
           <button className="btn border-2 px-6 p-2 bg-blue-700 hover:bg-blue-800 text-white rounded mb-32">
